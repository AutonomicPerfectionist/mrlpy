...
print(mcommand.sendCommand("runtime@elegant-robocop", "describe", ["fill-uuid", desc_query], sender="runtime@obsidian"))
print(mcommand.sendCommand("runtime@elegant-robocop", "onDescribe", [Runtime.describe()], sender="runtime@obsidian"))
